...
export default function PrivacyPolicy() {
  return (
    <div className="p-10 max-w-5xl mx-auto text-gray-800">
      ...
      <p className="mb-4">
        This Privacy Policy ("Policy") applies to https://www.avemariashuttle.com, and SUSU SEVERE CARS, LLC ("Company") and governs data collection and usage. By using the Company website, you consent to the data practices described in this statement.
...
The Company collects and uses your personal information in the following ways:  
 ...
 -	to notify you about changes to our https://www.avemariashuttle.com or any products or services we offer or provide through it 
...
If you would like to stop receiving marketing or promotional communications via email from the Company, you may opt out of such communications by clicking unsubscribe.. 
  
Changes to This Statement 
The Company reserves the right to change this Policy from time to time. For example, when there are changes in our services, changes in our data protection practices, or changes in the law. When changes to this Policy are significant, we will inform you. You may receive a notice by sending an email to the primary email address specified in your account, by placing a prominent notice on our SUSU SEVERE CARS, LLC, and/or by updating any privacy information. Your continued use of the website and/or services available after such modifications will constitute your: (a) acknowledgment of the modified Policy; and (b) agreement to abide and be bound by that Policy. 
...
The Company welcomes your questions or comments regarding this Policy. If you believe that the Company has not adhered to this Policy, please contact the Company at: 
        ...
        SUSU SEVERE CARS, LLC<br />
        1175 NE 125TH ST, 214<br />
        Miami, Florida 33161<br />
        Email: legal@avemariashuttle.com<br />
        Phone: 7542522868<br />
        <br />
        Effective as of June 14, 2025
      </p>
    </div>
  );
}
